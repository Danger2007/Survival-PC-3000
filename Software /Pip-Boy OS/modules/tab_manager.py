...
class TabManager:
    def __init__(self, screen):
        ...
        # --- AGGIUNTA: Inizializzazione centralizzata di player_data ---
        self.player_data = {
    ...
    def init_subtab_data(self):
        ...
        for tab_name, subtabs in settings.SUBTABS.items():
            # Se il nome della scheda non è presente nella lista self.tabs (es. modalità Fallout NV), salta
    ...
    def switch_tab(self, direction: bool):
        ...
        if self.ui_style == 'fallout_nv': #Fallout New Vegas
            if prev_tab_index == 0:
    ...
    def switch_sub_tab(self, direction: bool):
        ...
        # Ora usa i sottomenù corretti (compreso RADIO a indice 4)
        subtabs = self.get_current_subtabs()
